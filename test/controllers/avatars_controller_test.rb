...
class AvatarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avatar" do
    assert_difference('Avatar.count') do
      post avatars_url, params: { avatar: { image: @avatar.image, user_id: @avatar.user_id } }
    end
  ...
  test "should update avatar" do
    patch avatar_url(@avatar), params: { avatar: { image: @avatar.image, user_id: @avatar.user_id } }
